<?php
/**
 * File class-closedeventsrouter.php
 *
 * Router for all closed events action
 *
 * @since 2024-07-15
...
class ClosedEventsRouter {
	...
	public static function execute() {
		...
		ListItemsController::execute( ListItemsController::CLOSED_EVENTS, $page, $nonce );
	}
}
